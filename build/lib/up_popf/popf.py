...
class popfPDDLPlanner(PDDLPlanner):
    ...
    def _get_cmd(self, domain_filename: str,
        ...
        # popf_executable = os.path.join(os.environ.get('POPF_PREFIX'), 'plan')
        # cmd = ['/usr/bin/perl', popf_executable, domain_filename, problem_filename, plan_filename]
        # popf_executable = os.path.join(os.environ.get('POPF_PREFIX'), 'compile', 'popf2', 'popf3-clp')
        # cmd = [popf_executable, domain_filename, problem_filename]
        # cmd = [sys.executable, '/home/davide/planners/up-popf/up_popf/plan.py', domain_filename, problem_filename, plan_filename]
